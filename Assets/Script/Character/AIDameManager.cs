...
public class AIDameManager : MonoBehaviour
{
    ...
    public void OpenRightCollider()
    {
        ...
        Collider[] colliders = Physics.OverlapBox(target.transform.position, (_collider as BoxCollider).size);
    ...
    {
        Gizmos.DrawCube(target.transform.position, (_collider as BoxCollider).size);
    }
}
